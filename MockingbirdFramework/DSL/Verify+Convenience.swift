...
public func verify<T>(file: StaticString = #file, line: UInt = #line,
                      ...
                      _ mock1: @escaping @autoclosure () -> Mockable<T>) -> Verification<T> {
...
public func verify<T>(file: StaticString = #file, line: UInt = #line,
                      ...
                      _ mock2: @escaping @autoclosure () -> Mockable<T>) -> Verification<T> {
...
public func verify<T>(file: StaticString = #file, line: UInt = #line,
                      ...
                      _ mock3: @escaping @autoclosure () -> Mockable<T>) -> Verification<T> {
...
public func verify<T>(file: StaticString = #file, line: UInt = #line,
                      ...
                      _ mock4: @escaping @autoclosure () -> Mockable<T>) -> Verification<T> {
  return Verification({
...
public func verify<T>(file: StaticString = #file, line: UInt = #line,
                      ...
                      _ mock5: @escaping @autoclosure () -> Mockable<T>) -> Verification<T> {
  return Verification({
...
public func verify<T>(file: StaticString = #file, line: UInt = #line,
                      ...
                      _ mock6: @escaping @autoclosure () -> Mockable<T>) -> Verification<T> {
  return Verification({
...
public func verify<T>(file: StaticString = #file, line: UInt = #line,
                      ...
                      _ mock7: @escaping @autoclosure () -> Mockable<T>) -> Verification<T> {
  return Verification({
...
public func verify<T>(file: StaticString = #file, line: UInt = #line,
                      ...
                      _ mock8: @escaping @autoclosure () -> Mockable<T>) -> Verification<T> {
  return Verification({
...
public func verify<T>(file: StaticString = #file, line: UInt = #line,
                      ...
                      _ mock9: @escaping @autoclosure () -> Mockable<T>) -> Verification<T> {
  return Verification({

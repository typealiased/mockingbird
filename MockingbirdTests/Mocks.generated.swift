...
//
//  Generated by Mockingbird v0.1.3 on 8/29/19.
//  DO NOT EDIT
//
...
public final class ArgumentMatchingProtocolMock: MockingbirdTestsHost.ArgumentMatchingProtocol, Mockingbird.Mock {
  ...
  public func method(optionalStructType: @escaping @autoclosure () -> StructType?, optionalClassType: @escaping @autoclosure () -> ClassType?, optionalEnumType: @escaping @autoclosure () -> EnumType?, optionalStringType: @escaping @autoclosure () -> String?, optionalBoolType: @escaping @autoclosure () -> Bool?, optionalMetaType: @escaping @autoclosure () -> ClassType.Type?, optionalAnyType: @escaping @autoclosure () -> Any?, optionalAnyObjectType: @escaping @autoclosure () -> AnyObject?) -> Mockingbird.Stubbable<MockingbirdTestsHost.ArgumentMatchingProtocol, ArgumentMatchingProtocolMock, (StructType?, ClassType?, EnumType?, String?, Bool?, ClassType.Type?, Any?, AnyObject?) -> Bool, Bool> {
    ...
    return Mockingbird.Stubbable<MockingbirdTestsHost.ArgumentMatchingProtocol, ArgumentMatchingProtocolMock, (StructType?, ClassType?, EnumType?, String?, Bool?, ClassType.Type?, Any?, AnyObject?) -> Bool, Bool>(object: self, stubbingContext: stubbingContext, invocation: invocation)
  }
  ...
  public func method(structType: @escaping @autoclosure () -> StructType, classType: @escaping @autoclosure () -> ClassType, enumType: @escaping @autoclosure () -> EnumType, stringType: @escaping @autoclosure () -> String, boolType: @escaping @autoclosure () -> Bool, metaType: @escaping @autoclosure () -> ClassType.Type, anyType: @escaping @autoclosure () -> Any, anyObjectType: @escaping @autoclosure () -> AnyObject) -> Mockingbird.Stubbable<MockingbirdTestsHost.ArgumentMatchingProtocol, ArgumentMatchingProtocolMock, (StructType, ClassType, EnumType, String, Bool, ClassType.Type, Any, AnyObject) -> Bool, Bool> {
...
public final class ServiceRepositoryMock: MockingbirdTestsHost.ServiceRepository, Mockingbird.Mock {
  ...
  public var testManager: TestManager {
    get {
      ...
      mockingContext.didInvoke(invocation)
      return (stubbingContext.implementation(for: invocation) as! () -> TestManager)()
    }
    set {
      let invocation = Mockingbird.Invocation(selectorName: "testManager.set", arguments: [ArgumentMatcher(newValue)])
      mockingContext.didInvoke(invocation)
      let implementation = stubbingContext.implementation(for: invocation, optional: true)
      if let concreteImplementation = implementation as? (TestManager) -> Void {
        concreteImplementation(newValue)
      } else {
        (implementation as? () -> Void)?()
      }
  ...
  public func getTestManager() -> Mockingbird.Stubbable<MockingbirdTestsHost.ServiceRepository, ServiceRepositoryMock, () -> TestManager, TestManager> {
    let invocation = Mockingbird.Invocation(selectorName: "testManager.get", arguments: [])
    if let stub = DispatchQueue.currentStub { stubbingContext.swizzle(invocation, with: stub.implementation) }
    return Mockingbird.Stubbable<MockingbirdTestsHost.ServiceRepository, ServiceRepositoryMock, () -> TestManager, TestManager>(object: self, stubbingContext: stubbingContext, invocation: invocation)
  }

  public func setTestManager(_ newValue: @escaping @autoclosure () -> TestManager) -> Mockingbird.Stubbable<MockingbirdTestsHost.ServiceRepository, ServiceRepositoryMock, (TestManager) -> Void, Void> {
    let arguments = [Mockingbird.resolve(newValue)]
    let invocation = Mockingbird.Invocation(selectorName: "testManager.set", arguments: arguments)
    if let stub = DispatchQueue.currentStub { stubbingContext.swizzle(invocation, with: stub.implementation) }
    return Mockingbird.Stubbable<MockingbirdTestsHost.ServiceRepository, ServiceRepositoryMock, (TestManager) -> Void, Void>(object: self, stubbingContext: stubbingContext, invocation: invocation)
  }

  // MARK: Verifiable `testManager`

  public func getTestManager() -> Mockingbird.Mockable<TestManager> {
    let invocation = Mockingbird.Invocation(selectorName: "testManager.get", arguments: [])
    if let expectation = DispatchQueue.currentExpectation { expect(mockingContext, handled: invocation, using: expectation) }
    return Mockingbird.Mockable<TestManager>()
  }

  public func setTestManager(_ newValue: @escaping @autoclosure () -> TestManager) -> Mockingbird.Mockable<Void> {
    let arguments = [Mockingbird.resolve(newValue)]
    let invocation = Mockingbird.Invocation(selectorName: "testManager.set", arguments: arguments)
    if let expectation = DispatchQueue.currentExpectation { expect(mockingContext, handled: invocation, using: expectation) }
    return Mockingbird.Mockable<Void>()
...
public final class TestManagerMock: MockingbirdTestsHost.TestManager, Mockingbird.Mock {
  ...
  public var currentTest: Test {
    get {
      ...
      mockingContext.didInvoke(invocation)
      return (stubbingContext.implementation(for: invocation) as! () -> Test)()
    }
    set {
      let invocation = Mockingbird.Invocation(selectorName: "currentTest.set", arguments: [ArgumentMatcher(newValue)])
      mockingContext.didInvoke(invocation)
      let implementation = stubbingContext.implementation(for: invocation, optional: true)
      if let concreteImplementation = implementation as? (Test) -> Void {
        concreteImplementation(newValue)
      } else {
        (implementation as? () -> Void)?()
      }
  ...
  public func getCurrentTest() -> Mockingbird.Stubbable<MockingbirdTestsHost.TestManager, TestManagerMock, () -> Test, Test> {
    let invocation = Mockingbird.Invocation(selectorName: "currentTest.get", arguments: [])
    if let stub = DispatchQueue.currentStub { stubbingContext.swizzle(invocation, with: stub.implementation) }
    return Mockingbird.Stubbable<MockingbirdTestsHost.TestManager, TestManagerMock, () -> Test, Test>(object: self, stubbingContext: stubbingContext, invocation: invocation)
  }

  public func setCurrentTest(_ newValue: @escaping @autoclosure () -> Test) -> Mockingbird.Stubbable<MockingbirdTestsHost.TestManager, TestManagerMock, (Test) -> Void, Void> {
    let arguments = [Mockingbird.resolve(newValue)]
    let invocation = Mockingbird.Invocation(selectorName: "currentTest.set", arguments: arguments)
    if let stub = DispatchQueue.currentStub { stubbingContext.swizzle(invocation, with: stub.implementation) }
    return Mockingbird.Stubbable<MockingbirdTestsHost.TestManager, TestManagerMock, (Test) -> Void, Void>(object: self, stubbingContext: stubbingContext, invocation: invocation)
  }

  // MARK: Verifiable `currentTest`

  public func getCurrentTest() -> Mockingbird.Mockable<Test> {
    let invocation = Mockingbird.Invocation(selectorName: "currentTest.get", arguments: [])
    if let expectation = DispatchQueue.currentExpectation { expect(mockingContext, handled: invocation, using: expectation) }
    return Mockingbird.Mockable<Test>()
  }

  public func setCurrentTest(_ newValue: @escaping @autoclosure () -> Test) -> Mockingbird.Mockable<Void> {
    let arguments = [Mockingbird.resolve(newValue)]
    let invocation = Mockingbird.Invocation(selectorName: "currentTest.set", arguments: arguments)
    if let expectation = DispatchQueue.currentExpectation { expect(mockingContext, handled: invocation, using: expectation) }
    return Mockingbird.Mockable<Void>()
...
public final class TestMock: MockingbirdTestsHost.Test, Mockingbird.Mock {
  ...
  public var testCase: TestCase {
    get {
      ...
      mockingContext.didInvoke(invocation)
      return (stubbingContext.implementation(for: invocation) as! () -> TestCase)()
    }
    set {
      let invocation = Mockingbird.Invocation(selectorName: "testCase.set", arguments: [ArgumentMatcher(newValue)])
      mockingContext.didInvoke(invocation)
      let implementation = stubbingContext.implementation(for: invocation, optional: true)
      if let concreteImplementation = implementation as? (TestCase) -> Void {
        concreteImplementation(newValue)
      } else {
        (implementation as? () -> Void)?()
      }
  ...
  public func getTestCase() -> Mockingbird.Stubbable<MockingbirdTestsHost.Test, TestMock, () -> TestCase, TestCase> {
    let invocation = Mockingbird.Invocation(selectorName: "testCase.get", arguments: [])
    if let stub = DispatchQueue.currentStub { stubbingContext.swizzle(invocation, with: stub.implementation) }
    return Mockingbird.Stubbable<MockingbirdTestsHost.Test, TestMock, () -> TestCase, TestCase>(object: self, stubbingContext: stubbingContext, invocation: invocation)
  }

  public func setTestCase(_ newValue: @escaping @autoclosure () -> TestCase) -> Mockingbird.Stubbable<MockingbirdTestsHost.Test, TestMock, (TestCase) -> Void, Void> {
    let arguments = [Mockingbird.resolve(newValue)]
    let invocation = Mockingbird.Invocation(selectorName: "testCase.set", arguments: arguments)
    if let stub = DispatchQueue.currentStub { stubbingContext.swizzle(invocation, with: stub.implementation) }
    return Mockingbird.Stubbable<MockingbirdTestsHost.Test, TestMock, (TestCase) -> Void, Void>(object: self, stubbingContext: stubbingContext, invocation: invocation)
  }

  // MARK: Verifiable `testCase`

  public func getTestCase() -> Mockingbird.Mockable<TestCase> {
    let invocation = Mockingbird.Invocation(selectorName: "testCase.get", arguments: [])
    if let expectation = DispatchQueue.currentExpectation { expect(mockingContext, handled: invocation, using: expectation) }
    return Mockingbird.Mockable<TestCase>()
  }

  public func setTestCase(_ newValue: @escaping @autoclosure () -> TestCase) -> Mockingbird.Mockable<Void> {
    let arguments = [Mockingbird.resolve(newValue)]
    let invocation = Mockingbird.Invocation(selectorName: "testCase.set", arguments: arguments)
    if let expectation = DispatchQueue.currentExpectation { expect(mockingContext, handled: invocation, using: expectation) }
    return Mockingbird.Mockable<Void>()
  ...
  public func add(testCase: @escaping @autoclosure () -> TestCase) -> Mockingbird.Stubbable<MockingbirdTestsHost.Test, TestMock, (TestCase) -> Bool, Bool> {
    ...
    if let stub = DispatchQueue.currentStub { stubbingContext.swizzle(invocation, with: stub.implementation) }
    return Mockingbird.Stubbable<MockingbirdTestsHost.Test, TestMock, (TestCase) -> Bool, Bool>(object: self, stubbingContext: stubbingContext, invocation: invocation)
  }

  // MARK: Verifiable `add(testCase:)`

  public func add(testCase: @escaping @autoclosure () -> TestCase) -> Mockingbird.Mockable<Bool> {
    let arguments = [Mockingbird.resolve(`testCase`)]
    let invocation = Mockingbird.Invocation(selectorName: "add(testCase:) -> Bool", arguments: arguments)
    if let expectation = DispatchQueue.currentExpectation { expect(mockingContext, handled: invocation, using: expectation) }
    return Mockingbird.Mockable<Bool>()
...
public final class TopLevelTypeMock: MockingbirdTestsHost.TopLevelType, Mockingbird.Mock {
  ...
  public final class SecondLevelTypeMock: SecondLevelType, Mockingbird.Mock {
    ...
    public final class ThirdLevelInheritingTopLevelTypeMock: ThirdLevelInheritingTopLevelType, Mockingbird.Mock {
      ...
      public func thirdLevelInheritingMethod() -> Mockingbird.Stubbable<ThirdLevelInheritingTopLevelType, ThirdLevelInheritingTopLevelTypeMock, () -> Bool, Bool> {
        let invocation = Mockingbird.Invocation(selectorName: "thirdLevelInheritingMethod() -> Bool", arguments: [])
        if let stub = DispatchQueue.currentStub { stubbingContext.swizzle(invocation, with: stub.implementation) }
        return Mockingbird.Stubbable<ThirdLevelInheritingTopLevelType, ThirdLevelInheritingTopLevelTypeMock, () -> Bool, Bool>(object: self, stubbingContext: stubbingContext, invocation: invocation)
      }
    ...
    public final class ThirdLevelInheritingThirdLevelTypeMock: ThirdLevelInheritingThirdLevelType, Mockingbird.Mock {
      ...
      public func thirdLevelInheritingMethod() -> Mockingbird.Stubbable<ThirdLevelInheritingThirdLevelType, ThirdLevelInheritingThirdLevelTypeMock, () -> Bool, Bool> {
        let invocation = Mockingbird.Invocation(selectorName: "thirdLevelInheritingMethod() -> Bool", arguments: [])
        if let stub = DispatchQueue.currentStub { stubbingContext.swizzle(invocation, with: stub.implementation) }
        return Mockingbird.Stubbable<ThirdLevelInheritingThirdLevelType, ThirdLevelInheritingThirdLevelTypeMock, () -> Bool, Bool>(object: self, stubbingContext: stubbingContext, invocation: invocation)
      }

...
//
//  Generated by Mockingbird v0.1.3 on 8/30/19.
//  DO NOT EDIT
//
...
public final class AssociatedTypeImplementerProtocolMock: MockingbirdTestsHost.AssociatedTypeImplementerProtocol, Mockingbird.Mock {
  ...
  public func request<T: AssociatedTypeProtocol>(object: @escaping @autoclosure () -> T) -> Mockingbird.Stubbable<MockingbirdTestsHost.AssociatedTypeImplementerProtocol, AssociatedTypeImplementerProtocolMock, (T) -> T.HashableType, T.HashableType> where T.EquatableType == Bool, T.HashableType == String {
    let arguments = [Mockingbird.resolve(`object`)]
  ...
  public func request<T: AssociatedTypeProtocol>(object: @escaping @autoclosure () -> T) -> Mockingbird.Stubbable<MockingbirdTestsHost.AssociatedTypeImplementerProtocol, AssociatedTypeImplementerProtocolMock, (T) -> T.HashableType, T.HashableType> where T.EquatableType == Int, T.HashableType == String {
    let arguments = [Mockingbird.resolve(`object`)]
    let invocation = Mockingbird.Invocation(selectorName: "request(object:) -> T.HashableType", arguments: arguments)
    if let stub = DispatchQueue.currentStub { stubbingContext.swizzle(invocation, with: stub.implementation) }
    return Mockingbird.Stubbable<MockingbirdTestsHost.AssociatedTypeImplementerProtocol, AssociatedTypeImplementerProtocolMock, (T) -> T.HashableType, T.HashableType>(object: self, stubbingContext: stubbingContext, invocation: invocation)
  ...
  public func request<T: AssociatedTypeProtocol>(object: @escaping @autoclosure () -> T) -> Mockingbird.Stubbable<MockingbirdTestsHost.AssociatedTypeImplementerProtocol, AssociatedTypeImplementerProtocolMock, (T) -> Void, Void> where T.EquatableType == Int, T.HashableType == String {
    let arguments = [Mockingbird.resolve(`object`)]
...
public final class AssociatedTypeImplementerMock: MockingbirdTestsHost.AssociatedTypeImplementer, Mockingbird.Mock {
  ...
  public func request<T: AssociatedTypeProtocol>(object: @escaping @autoclosure () -> T) -> Mockingbird.Stubbable<MockingbirdTestsHost.AssociatedTypeImplementer, AssociatedTypeImplementerMock, (T) -> Void, Void> where T.EquatableType == Int, T.HashableType == String {
    let arguments = [Mockingbird.resolve(`object`)]
    let invocation = Mockingbird.Invocation(selectorName: "request(object:) -> Void", arguments: arguments)
    if let stub = DispatchQueue.currentStub { stubbingContext.swizzle(invocation, with: stub.implementation) }
...
public final class TopLevelTypeMock: MockingbirdTestsHost.TopLevelType, Mockingbird.Mock {
  ...
  public final class SecondLevelTypeMock: SecondLevelType, Mockingbird.Mock {
    ...
    public override func secondLevelMethod(param1: MockingbirdTestsHost.TopLevelType, param2: ThirdLevelType) -> Bool {
      ...
      mockingContext.didInvoke(invocation)
      let implementation = stubbingContext.implementation(for: invocation, optional: false)
      if let concreteImplementation = implementation as? (MockingbirdTestsHost.TopLevelType, ThirdLevelType) -> Bool {
        return concreteImplementation(`param1`, `param2`)
      } else {
        return (implementation as! () -> Bool)()
      }
    ...
    public func secondLevelMethod(param1: @escaping @autoclosure () -> MockingbirdTestsHost.TopLevelType, param2: @escaping @autoclosure () -> ThirdLevelType) -> Mockingbird.Stubbable<SecondLevelType, SecondLevelTypeMock, (MockingbirdTestsHost.TopLevelType, ThirdLevelType) -> Bool, Bool> {
      let arguments = [Mockingbird.resolve(`param1`), Mockingbird.resolve(`param2`)]
      let invocation = Mockingbird.Invocation(selectorName: "secondLevelMethod(param1:param2:) -> Bool", arguments: arguments)
      if let stub = DispatchQueue.currentStub { stubbingContext.swizzle(invocation, with: stub.implementation) }
      return Mockingbird.Stubbable<SecondLevelType, SecondLevelTypeMock, (MockingbirdTestsHost.TopLevelType, ThirdLevelType) -> Bool, Bool>(object: self, stubbingContext: stubbingContext, invocation: invocation)
    }
  
    // MARK: Verifiable `secondLevelMethod(param1:param2:)`
  
    public func secondLevelMethod(param1: @escaping @autoclosure () -> MockingbirdTestsHost.TopLevelType, param2: @escaping @autoclosure () -> ThirdLevelType) -> Mockingbird.Mockable<Bool> {
      let arguments = [Mockingbird.resolve(`param1`), Mockingbird.resolve(`param2`)]
      let invocation = Mockingbird.Invocation(selectorName: "secondLevelMethod(param1:param2:) -> Bool", arguments: arguments)
      if let expectation = DispatchQueue.currentExpectation { expect(mockingContext, handled: invocation, using: expectation) }
      return Mockingbird.Mockable<Bool>()
    ...
    public final class ThirdLevelInheritingTopLevelTypeMock: ThirdLevelInheritingTopLevelType, Mockingbird.Mock {
      ...
      public override func thirdLevelInheritingMethod() -> MockingbirdTestsHost.TopLevelType {
        let invocation = Mockingbird.Invocation(selectorName: "thirdLevelInheritingMethod() -> MockingbirdTestsHost.TopLevelType", arguments: [])
        mockingContext.didInvoke(invocation)
        let implementation = stubbingContext.implementation(for: invocation, optional: false)
      ...
      public func thirdLevelInheritingMethod() -> Mockingbird.Stubbable<ThirdLevelInheritingTopLevelType, ThirdLevelInheritingTopLevelTypeMock, () -> MockingbirdTestsHost.TopLevelType, MockingbirdTestsHost.TopLevelType> {
        let invocation = Mockingbird.Invocation(selectorName: "thirdLevelInheritingMethod() -> MockingbirdTestsHost.TopLevelType", arguments: [])
        if let stub = DispatchQueue.currentStub { stubbingContext.swizzle(invocation, with: stub.implementation) }
        return Mockingbird.Stubbable<ThirdLevelInheritingTopLevelType, ThirdLevelInheritingTopLevelTypeMock, () -> MockingbirdTestsHost.TopLevelType, MockingbirdTestsHost.TopLevelType>(object: self, stubbingContext: stubbingContext, invocation: invocation)
      }
    
      // MARK: Verifiable `thirdLevelInheritingMethod()`
    
      public func thirdLevelInheritingMethod() -> Mockingbird.Mockable<MockingbirdTestsHost.TopLevelType> {
        let invocation = Mockingbird.Invocation(selectorName: "thirdLevelInheritingMethod() -> MockingbirdTestsHost.TopLevelType", arguments: [])
        if let expectation = DispatchQueue.currentExpectation { expect(mockingContext, handled: invocation, using: expectation) }
        return Mockingbird.Mockable<MockingbirdTestsHost.TopLevelType>()
      }
    ...
    public final class ThirdLevelInheritingThirdLevelTypeMock: ThirdLevelInheritingThirdLevelType, Mockingbird.Mock {
      ...
      public override func thirdLevelInheritingMethod() -> MockingbirdTestsHost.TopLevelType.SecondLevelType.ThirdLevelType {
        let invocation = Mockingbird.Invocation(selectorName: "thirdLevelInheritingMethod() -> MockingbirdTestsHost.TopLevelType.SecondLevelType.ThirdLevelType", arguments: [])
        mockingContext.didInvoke(invocation)
        let implementation = stubbingContext.implementation(for: invocation, optional: false)
      ...
      public func thirdLevelInheritingMethod() -> Mockingbird.Stubbable<ThirdLevelInheritingThirdLevelType, ThirdLevelInheritingThirdLevelTypeMock, () -> MockingbirdTestsHost.TopLevelType.SecondLevelType.ThirdLevelType, MockingbirdTestsHost.TopLevelType.SecondLevelType.ThirdLevelType> {
        let invocation = Mockingbird.Invocation(selectorName: "thirdLevelInheritingMethod() -> MockingbirdTestsHost.TopLevelType.SecondLevelType.ThirdLevelType", arguments: [])
        if let stub = DispatchQueue.currentStub { stubbingContext.swizzle(invocation, with: stub.implementation) }
        return Mockingbird.Stubbable<ThirdLevelInheritingThirdLevelType, ThirdLevelInheritingThirdLevelTypeMock, () -> MockingbirdTestsHost.TopLevelType.SecondLevelType.ThirdLevelType, MockingbirdTestsHost.TopLevelType.SecondLevelType.ThirdLevelType>(object: self, stubbingContext: stubbingContext, invocation: invocation)
      }
    
      // MARK: Verifiable `thirdLevelInheritingMethod()`
    
      public func thirdLevelInheritingMethod() -> Mockingbird.Mockable<MockingbirdTestsHost.TopLevelType.SecondLevelType.ThirdLevelType> {
        let invocation = Mockingbird.Invocation(selectorName: "thirdLevelInheritingMethod() -> MockingbirdTestsHost.TopLevelType.SecondLevelType.ThirdLevelType", arguments: [])
        if let expectation = DispatchQueue.currentExpectation { expect(mockingContext, handled: invocation, using: expectation) }
        return Mockingbird.Mockable<MockingbirdTestsHost.TopLevelType.SecondLevelType.ThirdLevelType>()
      }
      ...
      public func thirdLevelMethod(param1: @escaping @autoclosure () -> MockingbirdTestsHost.TopLevelType, param2: @escaping @autoclosure () -> MockingbirdTestsHost.TopLevelType.SecondLevelType) -> Mockingbird.Stubbable<ThirdLevelInheritingThirdLevelType, ThirdLevelInheritingThirdLevelTypeMock, (MockingbirdTestsHost.TopLevelType, MockingbirdTestsHost.TopLevelType.SecondLevelType) -> Bool, Bool> {
        let arguments = [Mockingbird.resolve(`param1`), Mockingbird.resolve(`param2`)]
        let invocation = Mockingbird.Invocation(selectorName: "thirdLevelMethod(param1:param2:) -> Bool", arguments: arguments)
        if let stub = DispatchQueue.currentStub { stubbingContext.swizzle(invocation, with: stub.implementation) }
        return Mockingbird.Stubbable<ThirdLevelInheritingThirdLevelType, ThirdLevelInheritingThirdLevelTypeMock, (MockingbirdTestsHost.TopLevelType, MockingbirdTestsHost.TopLevelType.SecondLevelType) -> Bool, Bool>(object: self, stubbingContext: stubbingContext, invocation: invocation)
      }
    
      // MARK: Verifiable `thirdLevelMethod(param1:param2:)`
    
      public func thirdLevelMethod(param1: @escaping @autoclosure () -> MockingbirdTestsHost.TopLevelType, param2: @escaping @autoclosure () -> MockingbirdTestsHost.TopLevelType.SecondLevelType) -> Mockingbird.Mockable<Bool> {
        let arguments = [Mockingbird.resolve(`param1`), Mockingbird.resolve(`param2`)]
        let invocation = Mockingbird.Invocation(selectorName: "thirdLevelMethod(param1:param2:) -> Bool", arguments: arguments)
        if let expectation = DispatchQueue.currentExpectation { expect(mockingContext, handled: invocation, using: expectation) }
        return Mockingbird.Mockable<Bool>()
    ...
    public final class ThirdLevelInheritingPartiallyQualifiedThirdLevelTypeMock: ThirdLevelInheritingPartiallyQualifiedThirdLevelType, Mockingbird.Mock {
      ...
      public func thirdLevelInheritingMethod() -> Mockingbird.Stubbable<ThirdLevelInheritingPartiallyQualifiedThirdLevelType, ThirdLevelInheritingPartiallyQualifiedThirdLevelTypeMock, () -> MockingbirdTestsHost.TopLevelType.SecondLevelType.ThirdLevelType, MockingbirdTestsHost.TopLevelType.SecondLevelType.ThirdLevelType> {
        let invocation = Mockingbird.Invocation(selectorName: "thirdLevelInheritingMethod() -> MockingbirdTestsHost.TopLevelType.SecondLevelType.ThirdLevelType", arguments: [])
        if let stub = DispatchQueue.currentStub { stubbingContext.swizzle(invocation, with: stub.implementation) }
        return Mockingbird.Stubbable<ThirdLevelInheritingPartiallyQualifiedThirdLevelType, ThirdLevelInheritingPartiallyQualifiedThirdLevelTypeMock, () -> MockingbirdTestsHost.TopLevelType.SecondLevelType.ThirdLevelType, MockingbirdTestsHost.TopLevelType.SecondLevelType.ThirdLevelType>(object: self, stubbingContext: stubbingContext, invocation: invocation)
      }
      ...
      public func thirdLevelMethod(param1: @escaping @autoclosure () -> MockingbirdTestsHost.TopLevelType, param2: @escaping @autoclosure () -> MockingbirdTestsHost.TopLevelType.SecondLevelType) -> Mockingbird.Stubbable<ThirdLevelInheritingPartiallyQualifiedThirdLevelType, ThirdLevelInheritingPartiallyQualifiedThirdLevelTypeMock, (MockingbirdTestsHost.TopLevelType, MockingbirdTestsHost.TopLevelType.SecondLevelType) -> Bool, Bool> {
        let arguments = [Mockingbird.resolve(`param1`), Mockingbird.resolve(`param2`)]
        let invocation = Mockingbird.Invocation(selectorName: "thirdLevelMethod(param1:param2:) -> Bool", arguments: arguments)
        if let stub = DispatchQueue.currentStub { stubbingContext.swizzle(invocation, with: stub.implementation) }
        return Mockingbird.Stubbable<ThirdLevelInheritingPartiallyQualifiedThirdLevelType, ThirdLevelInheritingPartiallyQualifiedThirdLevelTypeMock, (MockingbirdTestsHost.TopLevelType, MockingbirdTestsHost.TopLevelType.SecondLevelType) -> Bool, Bool>(object: self, stubbingContext: stubbingContext, invocation: invocation)
      }
    ...
    public final class ThirdLevelInheritingFullyQualifiedThirdLevelTypeMock: ThirdLevelInheritingFullyQualifiedThirdLevelType, Mockingbird.Mock {
      ...
      public func thirdLevelInheritingMethod() -> Mockingbird.Stubbable<ThirdLevelInheritingFullyQualifiedThirdLevelType, ThirdLevelInheritingFullyQualifiedThirdLevelTypeMock, () -> MockingbirdTestsHost.TopLevelType.SecondLevelType.ThirdLevelType, MockingbirdTestsHost.TopLevelType.SecondLevelType.ThirdLevelType> {
        let invocation = Mockingbird.Invocation(selectorName: "thirdLevelInheritingMethod() -> MockingbirdTestsHost.TopLevelType.SecondLevelType.ThirdLevelType", arguments: [])
        if let stub = DispatchQueue.currentStub { stubbingContext.swizzle(invocation, with: stub.implementation) }
        return Mockingbird.Stubbable<ThirdLevelInheritingFullyQualifiedThirdLevelType, ThirdLevelInheritingFullyQualifiedThirdLevelTypeMock, () -> MockingbirdTestsHost.TopLevelType.SecondLevelType.ThirdLevelType, MockingbirdTestsHost.TopLevelType.SecondLevelType.ThirdLevelType>(object: self, stubbingContext: stubbingContext, invocation: invocation)
      }
      ...
      public func thirdLevelMethod(param1: @escaping @autoclosure () -> MockingbirdTestsHost.TopLevelType, param2: @escaping @autoclosure () -> MockingbirdTestsHost.TopLevelType.SecondLevelType) -> Mockingbird.Stubbable<ThirdLevelInheritingFullyQualifiedThirdLevelType, ThirdLevelInheritingFullyQualifiedThirdLevelTypeMock, (MockingbirdTestsHost.TopLevelType, MockingbirdTestsHost.TopLevelType.SecondLevelType) -> Bool, Bool> {
        let arguments = [Mockingbird.resolve(`param1`), Mockingbird.resolve(`param2`)]
        let invocation = Mockingbird.Invocation(selectorName: "thirdLevelMethod(param1:param2:) -> Bool", arguments: arguments)
        if let stub = DispatchQueue.currentStub { stubbingContext.swizzle(invocation, with: stub.implementation) }
        return Mockingbird.Stubbable<ThirdLevelInheritingFullyQualifiedThirdLevelType, ThirdLevelInheritingFullyQualifiedThirdLevelTypeMock, (MockingbirdTestsHost.TopLevelType, MockingbirdTestsHost.TopLevelType.SecondLevelType) -> Bool, Bool>(object: self, stubbingContext: stubbingContext, invocation: invocation)
      }
    ...
    public final class ThirdLevelTypeMock: ThirdLevelType, Mockingbird.Mock {
      ...
      public func thirdLevelMethod(param1: @escaping @autoclosure () -> MockingbirdTestsHost.TopLevelType, param2: @escaping @autoclosure () -> MockingbirdTestsHost.TopLevelType.SecondLevelType) -> Mockingbird.Stubbable<ThirdLevelType, ThirdLevelTypeMock, (MockingbirdTestsHost.TopLevelType, MockingbirdTestsHost.TopLevelType.SecondLevelType) -> Bool, Bool> {
        let arguments = [Mockingbird.resolve(`param1`), Mockingbird.resolve(`param2`)]
        let invocation = Mockingbird.Invocation(selectorName: "thirdLevelMethod(param1:param2:) -> Bool", arguments: arguments)
        if let stub = DispatchQueue.currentStub { stubbingContext.swizzle(invocation, with: stub.implementation) }
        return Mockingbird.Stubbable<ThirdLevelType, ThirdLevelTypeMock, (MockingbirdTestsHost.TopLevelType, MockingbirdTestsHost.TopLevelType.SecondLevelType) -> Bool, Bool>(object: self, stubbingContext: stubbingContext, invocation: invocation)
      }
